...
def run(cog_name: str, prompt: str, thread: dict):
    """
    Prompts a cog with the given prompt.
    ...
    Divvy up a knowledge base into specialized silos and assign a cog to each one.

    You yourself might be a cog and not know it. No way to know.
    """
    cogs = thread["cogs"]
